...
Desktopová WPF aplikace ElektroOffer 1.12.0 pro kalkulaci elektro prací a materiálu, tvorbu nabídek a fakturaci.
...
- vývoj ze zdrojového kódu: Visual Studio 2022+, .NET 10 SDK a workload **.NET Desktop Development**
...
Instalátor zatím není digitálně podepsaný. Windows proto může při prvním spuštění zobrazit upozornění SmartScreen na neznámého vydavatele; veřejná distribuce bez tohoto upozornění vyžaduje code-signing certifikát.
...
Automatické testy nejsou end-to-end test celé desktopové aplikace. V kontrolním běhu hotfixu prošlo **76 unit a 33 integračních testů**; po sloučení jejich výsledků je řádkové pokrytí produkčního C# kódu **57,4 %**. ARES klient dosahuje 91,9 %, modely 88,8 %, persistence 70,6 % a tisk/PDF 75,9 %. Slabší zůstávají ViewModely (40,5 %), start aplikace, motiv a code-behind oken. Tři dialogové smoke scénáře jsou `[Explicit]` a v běžném CI se nespouštějí.
