...
| Model               | Popis                                                                               |
| ------------------- | ----------------------------------------------------------------------------------- |
| `PriceItems`        | Ceník práce (úkon, specifikace, materiál, lokace, koeficienty, MJ)                  |
...
| `WorkItemData`      | Uložený řádek kalkulace práce (úkon, specifikace, materiál, lokace…)                |
...
| `ProjectData`       | Kompletní uložený projekt (`.eof`) — obsahuje WorkItems, MaterialItems, CommonItems |
