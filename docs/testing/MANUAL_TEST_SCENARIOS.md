...
| FLD-01 | Export a načtení katalogu | P0 | Hlavní DB s prací a materiálem | Exportovat `.eofcatalog`; přenést a načíst v Terénu | Zobrazí se katalogové položky se stabilními identitami; ceny se v Terénu nepočítají | — / Neprovedeno / — | Částečně |
...
| FLD-04 | Importní náhled | P0 | Platný `.eofmeasure` | Importovat; zkontrolovat mapování; vybrat řádky a přílohy | Nevyřešené řádky se nevloží; potvrzené používají aktuální hlavní ceník | — / Neprovedeno / — | Ano |
